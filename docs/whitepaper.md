[LaborCoin-Technical-Whitepaper-v1.0.md](https://github.com/user-attachments/files/28750527/LaborCoin-Technical-Whitepaper-v1.0.md)
Version: 1.0
...
11. Post-Renouncement Authority Structure.
...
Figure 4. Treasury Decision Lifecycle.
...
Figure 4. Treasury Flow Architecture.
...
Figure 7. Illustrative Treasury Growth Scenarios.
Treasury growth under increasing ecosystem participation. Not drawn to scale.
```
---
...
Unregistered --> PassportVerified
PassportVerified --> Authorized
Authorized --> Registered
Registered --> LABRVIssued
LABRVIssued --> GovernanceEligible
...
Draft --> ActiveVoting
ActiveVoting --> Rejected
ActiveVoting --> Approved
Approved --> Executable
Executable --> Executed
Executable --> Expired
...
Figure 10. Treasury Execution Lifecycle.
